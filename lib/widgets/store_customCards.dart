              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(order.isDineIn! == true ? "Dine - In" : "Dine - Out",
                ...
                Row(
                  children: [
                    ...
                    Text(order.isCOD! == true ? "COD" : "Online",
                        style: theme.textTheme.headlineSmall),
                  ],
                ),
              ],
...
CupertinoButton store_MenuCard(
    {required ThemeData theme,
    required BuildContext context,
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => BlocProvider(
            create: (context) => Modify_MenuItemCubit(),
            child: ModifyMenuItemScreen(menuItemModel: menuItem),
          ),
        ),
      );
    },
