...
class ChangeUserDetailsSuccessScreen extends StatefulWidget {
  const ChangeUserDetailsSuccessScreen({Key? key}) : super(key: key);

  @override
  State<ChangeUserDetailsSuccessScreen> createState() => _ChangeUserDetailsSuccessScreenState();
}

class _ChangeUserDetailsSuccessScreenState extends State<ChangeUserDetailsSuccessScreen> {
  @override
